			...
			<div class="container" style="width: 500px;">
				<form action="${pageContext.request.contextPath }/com/reg.action" method="post" id="login" name="login">
					...
					<div class="control-group">
						...
						<!--form提交，能够提交input的值到后台，通过name属性，后台通过name属性值获取参数  -->
						<input type="text" name="regbean.user.uname" id="username" value="" style=" width: 283px;" maxlength="18" rel="tooltip" data-original-title="请输入您的身份证号" data-placement="right"/>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<input type="text" name="regbean.user.userEmail"   value="" style=" width: 283px;" maxlength="18" rel="tooltip" data-original-title="请输入您的电子邮箱" data-placement="right"/>
					</div>
					<div class="control-group">
					...
					<div class="control-group" style="margin-bottom:0px;">
						...
						<span class="add-on" style="border:0px;">
							...
							<button type="button" class="btn btn-info" style="margin-bottom: 10px; margin-left: 20px;width:167px;" onclick="tologin()">返回主页</button>
						</div>
					</div>
				</form>
			</div>
					...
					window.location="./home.jsp";
						...
						<div align="left" style="width:100%; border-top:1px #CCC solid; margin-top:10px;">
							<table style="width:100%;">
								<tr>
									<td align="left">Copyright &copy; 2017  网上银行系统</td>
								</tr>
							</table>
						</div>
