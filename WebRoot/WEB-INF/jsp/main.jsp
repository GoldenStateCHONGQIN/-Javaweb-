...
<body scroll="no">
	<div id="layout">
		<div id="header">
			...
			<!-- navMenu -->
			<!--c if标签：控制显示哪一种信息，必须有test属性，当test表达式结果为TRUE，执行本体。  -->
			<div id="navMenu">
				<ul>
					<c:if test="${SESSION_BEAN.role=='SysUser' }">
						<li class="selected"><a href="${ctx}/sidebar/sidebar1.jsp"><span>系统管理</span></a></li>
						<li><a href="${ctx}/sidebar/sidebar2.jsp"><span>信用卡管理</span></a></li>
						<li><a href="${ctx}/sidebar/sidebar3.jsp"><span>网上支付管理</span></a></li>
						<li><a href="${ctx}/sidebar/sidebar4.jsp"><span>保险系统管理</span></a></li>
					</c:if>
					<c:if test="${SESSION_BEAN.role=='SimpleUser' }">
						<li class="selected"><a href="${ctx}/sidebar/sidebar5.jsp"><span>信用卡信息</span></a></li>
						<li ><a href="${ctx}/sidebar/sidebar6.jsp"><span>网上支付</span></a></li>
					</c:if>
				</ul>
			</div>
		</div>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="pageFormContent" layoutH="80" style="margin-right:230px">
							<p style="color:red">欢迎使用${appTitle }: ${SESSION_BEAN.user.user.userName}&nbsp;&nbsp;&nbsp;
							</p>
							<p style="color:red"> </p>
