...
<form id="pagerForm" method="post" action="${ctx}/sys/queryUserCardBank.action">
	<input type="hidden" name="pageNum" value="" />
</form>
<!-- 用户：银行卡信息查询jsp -->
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/sys/queryUserCardBank.action" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="${ctx}/sys/getUserCard.action?uid={sid_select}" target="navTab" rel="baseAdd" warn="请选择一条信息,点击需要修改的行" title="银行卡"><span>查看</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid_select" rel="${item.id }">
				...
				<td width="70">
					<a title="银行卡"  href="${ctx}/sys/getUserCard.action?uid=${item.id}" class="btnEdit" target="navTab" rel="baseAdd">查看</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
