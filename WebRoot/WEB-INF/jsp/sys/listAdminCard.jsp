...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="${ctx}/sys/getAdminCard.action?uid={sid_select}" target="navTab" rel="baseAdd" warn="请选择一条信息,点击需要修改的行" title="信用卡信息"><span>管理</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid_select" rel="${item.id }">
				...
				<td>${item.credits}</td>
				<td width="70">
					<a title="信用卡信息"  href="${ctx}/sys/getAdminCard.action?uid=${item.id}" class="btnEdit" target="navTab" rel="baseAdd">信用卡信息</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
