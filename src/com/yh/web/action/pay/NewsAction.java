...
public class NewsAction extends BaseAction implements ModelDriven<News> {
	...
	@Action(value = "add2News", results = { @Result(name = "add2", location = "/WEB-INF/jsp/pay/addNews.jsp") })
	public String add2() {
		return "add2";
	}

	@Action(value = "getNews", results = { @Result(name = "getOne", location = "/WEB-INF/jsp/pay/modifyNews.jsp") })
	public String get() {
		try {
	...
	@Action(value = "queryNews", results = { @Result(name = "queryList", location = "/WEB-INF/jsp/pay/listNews.jsp") })
	public String query() {
		try {
			int pageNum = 0;
